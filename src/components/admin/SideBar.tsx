...
function Sidebar() {
  ...
  return (
    <aside className="bg-main border-main/10 fixed top-18 right-2 left-2 z-50 flex h-14 items-center rounded-2xl border py-4 shadow-lg transition-all duration-300 sm:static sm:h-auto md:col-span-2 md:flex-col md:py-10 md:shadow-none lg:col-span-1">
