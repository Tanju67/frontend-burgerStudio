...
function Board() {
  return (
    <div className="bg-bg text-text-dark border-main/10 col-span-4 mt-37 min-h-[80vh] overflow-hidden rounded-2xl border shadow-xl transition-colors duration-300 sm:mt-42 md:mt-0 md:min-h-full">
